"""
Django settings for bkt_crm project.
...
SECRET_KEY = '2j+8w4%!%q)b5g=votzko%@12l_(#v9an50=03@!5$u$%vyy-e'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'lead.middlewares.lead_context_processor',
            ],
        },
    },
]
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'bkt_crm/static'),
)
